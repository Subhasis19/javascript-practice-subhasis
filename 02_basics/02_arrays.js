...
const another_array = [1,2,3 ,[4,5,6] , 7, 8 ,[2,4,6,[3,5]] ]
...
// console.log(Array.isArray("Subhasis"));
// console.log(Array.from("Subhasis")); //Creates an array from an iterable object
// console.log(Array.from({name : "Subhasis"})); // interesting output
